namespace RazorEngine.Compilation
{
    ...
    using RazorTemplateEngineInternal;
...
";
        ...
        private static RazorPageGeneratorResult GenerateCodeFile(RazorTemplateEngineInternal templateEngine, RazorCodeDocument document)
        {
