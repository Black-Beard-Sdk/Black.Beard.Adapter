...
namespace Bb.ComponentModel
{
    ...
    public static class ConnexionReaderExtension
    {
        ...
        public static Dictionary<string, string> GetKeyValues(this string connectionString)
        {

            Dictionary<string, string> e = new Dictionary<string, string>();
            DbConnectionOptions constr = new DbConnectionOptions(connectionString, null, false);
